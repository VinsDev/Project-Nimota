...
class _StudentProfileState extends State<StudentProfile> {
          ...
          children: [
            ...
            field(
                ...
                MainStore.classes[widget.classIndex].terms[widget.termIndex]
                    .students[widget.studentIndex].classEnrolment,
                saveClassEnrolment),
            field(
                "Age",
                MainStore.classes[widget.classIndex].terms[widget.termIndex]
            ...
            field(
                "Days out of School",
                MainStore.classes[widget.classIndex].terms[widget.termIndex]
                    .students[widget.studentIndex].doc,
                saveDaysOutOfSchool),
            field(
                "Fees Owed",
                MainStore.classes[widget.classIndex].terms[widget.termIndex]
  ...
  void saveDaysOutOfSchool(String value) {
    setState(() {
      MainStore.classes[widget.classIndex].terms[widget.termIndex]
          .students[widget.studentIndex].doc = value;
  ...
  void saveClassEnrolment(String value) {
    setState(() {
      MainStore.classes[widget.classIndex].terms[widget.termIndex]
          .students[widget.studentIndex].classEnrolment = value;
      classBox.put(widget.classKey, MainStore.classes[widget.classIndex]);
    });
    Navigator.of(context).pop();
  }
